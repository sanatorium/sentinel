...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to sanityd "gobject list" output
    ...
    def sanityd_serialise(self):
        import sanitylib
        return sanitylib.SHIM_serialise_for_sanityd(self.serialise())
